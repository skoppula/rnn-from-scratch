...
class LSTM_rnn():
    ...
    def __init__(self, state_size, num_classes,
        ...
        def __graph__():
            ...
            def step_additive_forget_input_no_sigmoid(prev, x):
            ...
            states = tf.scan(step_additive_forget_input_no_sigmoid,
    ...
    def train(self, train_set, val_set, num_steps_trn_epoch, num_steps_val_epoch, epochs=500):
...
if __name__ == '__main__':
    ...
    args = parse_args()
    X_trn, y_trn, X_test, y_test, idx2w, w2idx = data.load_data('data/paulg/')
